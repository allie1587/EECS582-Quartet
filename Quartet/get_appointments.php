...
if ($barberID !== null && $time !== null) {
    $stmt->bind_param("iiiiiiiiiiiss", $weekday, $month, $day, $year, $month, $day, $year, $weekday, $month, $day, $year, $barberID, $time);
} else if ($barberID !== null) {
    $stmt->bind_param("iiiiiiiiiiis", $weekday, $month, $day, $year, $month, $day, $year, $weekday, $month, $day, $year, $barberID);
} else if ($time !== null) {
    $stmt->bind_param("iiiiiiiiiiis", $weekday, $month, $day, $year, $month, $day, $year, $weekday, $month, $day, $year, $time);
} else {
    $stmt->bind_param("iiiiiiiiiii", $weekday, $month, $day, $year, $month, $day, $year, $weekday, $month, $day, $year);
}
$stmt->execute();
